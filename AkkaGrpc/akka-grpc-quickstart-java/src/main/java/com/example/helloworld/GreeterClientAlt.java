...
class GreeterClientAlt {
    ...
    public static void main(String[] args) {
        ...
        names.forEach(name -> {
            ...
            Source<HelloReply, NotUsed> responseStream = greeterServiceClient.keepSayingHello(requestStream);
            ...
            CompletionStage<Done> done =
                ...
                if (error == null) {
                    System.out.println("streamingReply done");
                } else {
                    System.out.println("Error streamingReply: " + error);
                }
            });
